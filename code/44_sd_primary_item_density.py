"""
Social Distance: Primary Out-group — Item-Level Distribution Shapes
=====================================================================
Two-row × 3-column figure: top row = Russian (rating Estonian-speakers),
bottom row = Estonian (rating Russian-speakers), each column = one of the
three SD Primary items.

  Column 1 — Neighbors (Q57_*  / K4X7_*)
  Column 2 — Work / study (Q58_* / K4X8_*)
  Column 3 — Marriage in family (Q59_* / K4X9_*)

Group-specific items:
  Estonians: Q57_1 / Q58_1 / Q59_1  (2020: K4X7_1 / K4X8_1 / K4X9_1)
  Russians:  Q57_2 / Q58_2 / Q59_2  (2020: K4X7_2 / K4X8_2 / K4X9_2)

Direction: scale 1–5, NO reverse coding. Higher = more social distance.

Output: viz/fig_sd_primary_item_density.jpg  (300 DPI)
"""
...
# Item specifications: (label, est23, rus23, est20, rus20)
ITEMS = [
    ("Neighbors",          "Q57_1", "Q57_2", "K4X7_1", "K4X7_2"),
    ("Work / study",       "Q58_1", "Q58_2", "K4X8_1", "K4X8_2"),
    ("Marriage in family", "Q59_1", "Q59_2", "K4X9_1", "K4X9_2"),
]
...
# ---------- Diagnostics -----------------------------------------------------
print("="*92)
print("SD: PRIMARY OUT-GROUP — item-level diagnostics")
...
# Title and footer
fig.text(0.03, 0.968,
         "SD: Primary Out-group — Item-Level Distribution Shapes 2020 → 2023",
...
fig.text(0.03, 0.927,
         "Higher x = more reluctance to accept the primary out-group in that role.",
         fontsize=9, color="#444")

fig.text(0.03, 0.030,
         "Group-specific item codes shown above each panel. Scale 1–5, no reverse coding "
         "(raw direction already aligns with 'higher = more distance').",
...
out = ROOT / "viz" / "fig_sd_primary_item_density.jpg"
