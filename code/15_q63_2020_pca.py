...
# K6X1: same Q63 battery as 2023
# Scale: 1 = strongly agree ... 4 = strongly disagree; 9 = DK -> NaN
# K6X1_1: Ethnic conflicts inevitable (negative)
# K6X1_2: Intercultural differences divide society (negative)
# K6X1_3: Different groups can cooperate (positive) -> reverse-code
# K6X1_4: Immigration enriches culture (positive) -> reverse-code

items_raw = ["K6X1_1", "K6X1_2", "K6X1_3", "K6X1_4"]

for col in items_raw:
    df[col] = df[col].replace(9, np.nan)

df["K6X1_3_inv"] = 5 - df["K6X1_3"]
df["K6X1_4_inv"] = 5 - df["K6X1_4"]

items = ["K6X1_1", "K6X1_2", "K6X1_3_inv", "K6X1_4_inv"]
